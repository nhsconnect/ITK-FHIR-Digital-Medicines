...
| Person accompanying patient         | Identify,   where clinically relevant, others accompanying the patient, eg parent,   relative, friend. Includes: Name, Relationship, role (e.g. informal carer).                          | 0   TO MANY | Free   text                                                                                                                                                                                   | <font color="red">Optional</font>                         | Composition.section.text                                                                                                                                                                                |
