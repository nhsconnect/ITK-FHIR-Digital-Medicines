...
## ITK3 Digital Medicines DMIRS FHIR Document Bundle ##

The document bundle is a collection of FHIR Resource Profiles combined to support the Digital Medicines DMIRS FHIR Document.
...
For a complete definition of the Digital Medicines DMIRS document see the section on [message definitions.](explore_immunization_def.html)
