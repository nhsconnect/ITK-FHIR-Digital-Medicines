...
<table style="width:100%;max-width: 100%;">
	...
	<tbody>
		...
		<tr>
			...
			<td>0 to 1</td>
			<td>R</td>
			<td>Carried in the CodeableConcept of <b>MedicationDispense.type</b> FHIR element.</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>0 to 1</td>
			<td>R</td>
			<td>A free text or code derived text term giving the clinical indication or reason for ordering the medication. Carried in the <b>MedicationDispense.type</b> FHIR element.</td>
		</tr>
		<tr>
			...
			<td>1 only</td>
			<td>M</td>
			<td>Free text. Carried in the <b>TBC</b> FHIR element.</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>1 only</td>
			<td>M</td>
			<td>Recorded in a structured format i.e. a unit (eg ml, tablet, etc.) and a value (eg 100, 1, 0.5 etc.). Carried in the <b>TBC</b> FHIR element.</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>0 to 1</td>
			<td>R</td>
			<td>The date/time as recorded by the pharmacy system. Carried in the <b>TBC</b> FHIR element.</td>
		</tr>
		<tr>
