...
| Indication                          | Reason for medication being supplied, where known. | 0 TO 1  | This will be free text | <font color="red">Optional</font>  | N/A as not available within the MedicationDispense resource  |
...
| Days Supply                         | Amount of medication supplied expressed as a number of days. | 0 TO 1 | Recorded as a number of days (eg 7 days) | Required | MedicationDispense. daysSupply |
